            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ lineHeight: '1.6', color: 'rgb(203, 213, 225)' }}>
                        OSRS Profit Tracker is operated by Daan Bom, located in Den Haag, Netherlands.
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <ul style={{ marginLeft: '2rem', marginBottom: '1rem', color: 'rgb(203, 213, 225)' }}>
                        ...
                        <li>Third-Party services may collect technical data</li>
                    </ul>
                </section>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '1rem' }}>6. Your Privacy Rights</h2>
                    <p style={{ lineHeight: '1.6', color: 'rgb(203, 213, 225)', marginBottom: '1rem' }}>
                        We respect the privacy rights of all users globally. If you are located in the European Union, you have
                        specific rights under GDPR. Regardless of your location, we strive to provide the following rights to all users:
                    </p>
                    <ul style={{ marginLeft: '2rem', marginBottom: '1rem', color: 'rgb(203, 213, 225)' }}>
